...
class UserController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Id,Firstname,Lastname,Email,Phone,Mobile,Status'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$user->Mobile = $this->SafeGetVal($json, 'mobile');
	...
	public function Update()
	{
		try
		{
			...
			$user->Mobile = $this->SafeGetVal($json, 'mobile', $user->Mobile);
